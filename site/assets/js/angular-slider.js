  ...
  var module = angular.module('rzModule', [])
    ...
    .factory('RzSlider', ['$timeout', '$document', '$window', '$compile', 'RzSliderOptions', 'rzThrottle', function($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
      ...
      var Slider = function(scope, sliderElem) {
        ...
        /**
         * The slider inner low value (linked to rzSliderValue)
         * @type {number}
         */
        this.lowValue = 0;
         ...
         */
        this.range = this.scope.rzSliderValue !== undefined && this.scope.rzSliderHigh !== undefined;
      ...
      Slider.prototype = {
        ...
        init: function() {
          ...
          this.scope.$watch('rzSliderValue', function(newValue, oldValue) {
        ...
        syncLowValue: function() {
          if (this.options.stepsArray) {
            if (!this.options.bindIndexForStepsArray)
              this.lowValue = this.findStepIndex(this.scope.rzSliderValue);
            else
              this.lowValue = this.scope.rzSliderValue
          }
          else
            this.lowValue = this.scope.rzSliderValue;
        },
        ...
        applyLowValue: function() {
          if (this.options.stepsArray) {
            if (!this.options.bindIndexForStepsArray)
              this.scope.rzSliderValue = this.getStepValue(this.lowValue);
            else
              this.scope.rzSliderValue = this.lowValue
          }
          else
            this.scope.rzSliderValue = this.lowValue;
        },
        ...
        updateAriaAttributes: function() {
          this.minH.attr({
            'aria-valuenow': this.scope.rzSliderValue,
            'aria-valuetext': this.customTrFn(this.scope.rzSliderValue, this.options.id, 'model'),
        ...
        getSelectionBarColor: function() {
          if (this.range)
            return this.options.getSelectionBarColor(this.scope.rzSliderValue, this.scope.rzSliderHigh);
          return this.options.getSelectionBarColor(this.scope.rzSliderValue);
        },
        ...
        getPointerColor: function(pointerType) {
          ...
          return this.options.getPointerColor(this.scope.rzSliderValue, pointerType);
        },
        ...
        callOnStart: function() {
          if (this.options.onStart) {
            ...
            this.scope.$evalAsync(function() {
              self.options.onStart(self.options.id, self.scope.rzSliderValue, self.scope.rzSliderHigh, pointerType);
            });
          }
        },
        ...
        callOnChange: function() {
          if (this.options.onChange) {
            var self = this,
              pointerType = this.tracking === 'lowValue' ? 'min' : 'max';
            this.scope.$evalAsync(function() {
              self.options.onChange(self.options.id, self.scope.rzSliderValue, self.scope.rzSliderHigh, pointerType);
            });
          }
        },
        ...
        callOnEnd: function() {
          if (this.options.onEnd) {
            var self = this,
              pointerType = this.tracking === 'lowValue' ? 'min' : 'max';
            this.scope.$evalAsync(function() {
              self.options.onEnd(self.options.id, self.scope.rzSliderValue, self.scope.rzSliderHigh, pointerType);
            });
          }
    ...
    .directive('rzslider', ['RzSlider', function(RzSlider) {
      ...
      return {
        ...
        link: function(scope, elem) {
          ...
          scope.$watch('rzSliderModel', function(newValue, oldValue) {
            if (newValue !== oldValue) {
              scope.slider = new RzSlider(scope, elem);
            }
          });
        }
      };
