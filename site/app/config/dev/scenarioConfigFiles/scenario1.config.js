    ...
    self.scenario = {
        ...
        dynamicLayers: {
            ...
            "CeilingLightAnimation": {
                ...
                geometrySource: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.CEILINGLIGHT_POLYGON.TEST,
                sourceType: "nodeServer",
                url: "",
                initialVisible: true,
                display: "indoorSharedLayer"
        ...
        scenario3Dlayers: [
            ...
            },
            {
                ...
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.UC3D_LABEL.TEST,
                type: "LabelLayer",
                opacity: 1,
            ...
            },
            {
                ...
                title: "Gateway",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.GATEWAY.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name:{name}",
            ...
            },
            {
                ...
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.SMOKE_DETECTOR.TEST,
                popupEnabled: true,
                monitor2DMap: true,
                popupTemplate: {
                    title: "Name: {name}",
            ...
            },
            {
                ...
                title: "Built-in Plugbase",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.BUILTIN_PLUG.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
                    content: "<ul><li>DeviceEUI: {deviceeui}</li>"
                        + "<li>Energy Consumption: <span id='energy-consumption' device-type='builtinplug' object-id='" + "{objectid}" + "'>-</span></li></ul>"
                },
                type: "FeatureLayer",
                returnZ: true,
                elevationInfo: { mode: "absolute-height" },
            ...
            },
            {
                ...
                title: "Plug base",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.PLUGBASE.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
            ...
            },
            {
                ...
                title: "Body Sensor",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.DETECTOR.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
            ...
            },
            {
                ...
                title: "Ceiling Light",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.CEILINGLIGHT.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
            ...
            },
            {
                ...
                title: "Camera",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.CAMERA.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
            ...
            },
            {
                ...
                title: "Street Lamp",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.STREETLAMP.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name:{name}",
            ...
            },
            {
                ...
                url: "/3D_WebGIS_Angular_ESRI_Canada_Test/FeatureServer/14",
                popupEnabled: true,
                popupTemplate: {
                    title: "Name:{name}",
            ...
            },
            {
                ...
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.UOFC.INDOOR.TEST,
                popupEnabled: true,
                popupTemplate: {
                    title: "Name: {name}",
        ...
        scenarioIndoorLayers: [ //indoor 3D model layers
            {
                ...
                relatedLayerExpressions: [
                    //apply filter will cause indoor segment doesn't show up once go inside
                    // log out or switch senario will fix this issue 
                    // comment out for now till find the solution 
                    {
