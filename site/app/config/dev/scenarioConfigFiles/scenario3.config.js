    ...
    self.scenario = {
        ...
        dynamicLayers: {
            ...
            "CeilingLightAnimation": {
                ...
                geometrySource: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.CEILINGLIGHT_POLYGON.TEST,
                sourceType: "nodeServer",
                url: "",
                initialVisible: true,
                display: "indoorSharedLayer"
        ...
        scenario3Dlayers: [
            ...
            },
            {
                id: "3DTAG",
                title: "3D标签",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.LABEL.TEST,
                type: "LabelLayer",
                opacity: 1,
            ...
            },
            {
                ...
                title: "水箱",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.WATERTANK.TEST,
                monitor2DMap: true,
                type: "FeatureLayer",
                opacity: 0.5,
                popupEnabled: true,
            ...
            },
            {
                ...
                title: "太阳能板",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.SOLARBOARD.TEST,
                monitor2DMap: true,
                type: "FeatureLayer",
                opacity: 1,
                popupEnabled: true,
            ...
            },
            {
                ...
                title: "风电设备",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.WIND.TEST,
                monitor2DMap: true,
                type: "FeatureLayer",
                opacity: 1,
                popupEnabled: true,
            ...
            },
            {
                ...
                title: "路灯",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.STREETLAMP.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "外置插座（中国）",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.PLUGBASECN.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "内置插座（中国）",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.BUILTIN_PLUG.TEST,
                popupEnabled: true,
                monitor2DMap: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "人体感应器",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.DETECTOR.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "顶灯",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.CEILINGLIGHT.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "3D能源消耗",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.POWER_CONSUMPTION_3D.TEST,
                popupEnabled: true,
                popupTemplate: {
                    title: "栅格编号:{cell_id}",
            ...
            },
            {
                ...
                title: "烟雾感应器",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.SMOKEDETECTOR.TEST,
                monitor2DMap: true,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称: {name}",
            ...
            },
            {
                ...
                title: "停车场",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.PARKINGLOT.TEST,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称:{name}",
            ...
            },
            {
                ...
                title: "智能充电桩",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.SMARTCHARGER.TEST,
                popupEnabled: true,
                popupTemplate: {
                    title: "名称:{name}",
                    content: "<ul><li>设备识别号: {deviceeui}</li></ul>"
            ...
            },
            {
                ...
                title: "绿化植被",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.OUTDOOR_VEGETATION.TEST,
                inGrouplayer: true,
                type: "FeatureLayer",
            ...
            },
            {
                ...
                title: "室内植被",
                url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.INDOOR_VEGETATION.TEST,
                type: "FeatureLayer",
                symbolType: "mutiWebStyleSymbol",
                symbolAttribute: "tree_type",
                symbolConfig: [
        ...
        undergroundLayers: {
            dynamicLayers: [{
                ...
                geometrySource: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.WATER_PIPES_ANIMATION.TEST,
                initialVisible: true
            }],
            scenario3Dlayers: [
                {
                ...
                },
                {
                    ...
                    id: "trees",
                    title: "树木",
                    url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.OUTDOOR_VEGETATION_UNDERGROUND.TEST,
                    type: "FeatureLayer",
                    opacity: 1
                }, {
                    id: 3D_WebGIS_Angular_ESRI.WATER_PIPES,
                    title: "水管管线",
                    url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.WATER_PIPES.TEST,
                    type: "FeatureLayer",
                    returnZ: true,
                    elevationInfo: { mode: "absolute-height" },
                    popupEnabled: true,
                ...
                },
                {
                    ...
                    title: "电线管道",
                    url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.ELECTRIC_PIPELINES.TEST,
                    type: "FeatureLayer",
                    returnZ: true,
                    elevationInfo: { mode: "absolute-height" },
                    popupEnabled: true,
                ...
                },
                {
                    ...
                    title: "阀门",
                    url: 3D_WebGIS_Angular_ESRI_LAYER_URL.HUAYUANFANG.WATER_VALVE.TEST,
                    popupEnabled: true,
                    popupTemplate: {
                        title: "空间序列号: {objectid}"
                    },
